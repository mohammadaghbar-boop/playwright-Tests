...
const { login, DEFAULT_USER, JUDGE_USER } = require('../../support/auth');
 ...
 */
function interceptNextJsonResponse(page, timeout = 15000) {
...
const searchInput = (page) => page.locator('input[placeholder*="رقم"]').first();
 ...
 */
async function clickPSelectOption(page, labelText, targetIndex = 1) {
